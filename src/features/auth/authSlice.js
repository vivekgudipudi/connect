...
export const loginHandler = createAsyncThunk('authentication/loginHandler',async({cred,navigate,location},thunkAPI)=>{
...
export const signupHandler = createAsyncThunk('authentication/signupHandler',async({entries,navigate,location},thunkAPI)=>{
    try{
